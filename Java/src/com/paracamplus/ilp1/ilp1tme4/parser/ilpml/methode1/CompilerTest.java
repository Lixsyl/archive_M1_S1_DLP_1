 ...
 * GPL version 3
 ***************************************************************** */
package com.paracamplus.ilp1.ilp1tme4.parser.ilpml.methode1;
...
public class CompilerTest {
    ...
    private static String[] samplesDirName = { "SamplesTME4" };
    private static String pattern = ".*\\.ilpml";
    private static String scriptCommand = "Java/src/com/paracamplus/ilp1/ilp1tme3/C/compileThenRun.sh +gc";
