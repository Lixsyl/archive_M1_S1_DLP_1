...
public class ILPMLParserEx2p2 extends ILPMLParser {

	public ILPMLParserEx2p2(IASTfactory factory) {
		super(factory);
	}
    ...
    public IASTprogram getProgram() throws ParseException {
		try {
			...
			IASTprogram ast = tree.node;
	        CountConstants countConstants = new CountConstants();
	        int count = countConstants.visit(ast, null);
	        System.out.println("Nombre de constantes dans l'AST : " + count);
